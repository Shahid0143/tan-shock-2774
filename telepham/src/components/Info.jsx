  ...
  return (
    <div className="infosec" id="infosec">
      <div className="infomain">
        <h3>
          Stay Healthy with SHAHID: Your Favourite Online Pharmacy and
          Healthcare Platform
        </h3>
        <h4>We Bring Care to Health.</h4>
        <p>
          SHAHID is India's leading digital healthcare platform. From doctor
        ...
        <h4>SHAHID: Your Favourite Online Pharmacy!</h4>
        <p>
          SHAHID is India's leading online chemist with over 2 lakh medicines
          ...
          medicines. <br />
          <br /> With SHAHID, you can buy medicines online and get them
          ...
          <br />
          <br /> And there is more! At SHAHID, you can buy health products and
          medicines online at best discounts.
          <br />
          <br /> Now, isn't that easy? Why go all the way to the medicine store
          and wait in line, when you have SHAHID Pharmacy at your service.
        </p>
        <h4>The Feathers in Our Cap</h4>
        <p>
          At SHAHID, our goal is to make healthcare understandable, accessible

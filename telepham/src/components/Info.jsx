...
export default function Information() {
  return (
    <div className="infosec" id="infosec">
      <div className="infomain">
        <h3>
          Stay Healthy with 2Mg: Your Favourite Online Pharmacy and Healthcare
          Platform
        </h3>
        <h4>We Bring Care to Health.</h4>
        <p>
          2Mg is India's leading digital healthcare platform. From doctor
        ...
        <h4>2Mg: Your Favourite Online Pharmacy!</h4>
        <p>
          2Mg is India's leading online chemist with over 2 lakh medicines
          ...
          medicines. <br />
          <br /> With 2Mg, you can buy medicines online and get them delivered
          at your doorstep anywhere in India! But, is ordering medicines online
          a difficult process? Not at all! Simply search for the products you
          want to buy, add to cart and checkout. Now all you need to do is sit
          back as we get your order delivered to you.
          <br />
          <br /> In case you need assistance, just give us a call and we will
          help you complete your order.
          <br />
          <br /> And there is more! At 2Mg, you can buy health products and
          medicines online at best discounts.
          <br />
          <br /> Now, isn't that easy? Why go all the way to the medicine store
          and wait in line, when you have 2Mg Pharmacy at your service.
        </p>
        <h4>The Feathers in Our Cap</h4>
        <p>
          At 2Mg, our goal is to make healthcare understandable, accessible and
          affordable in India. We set out on our journey in 2015, and have come
          a long way since then. Along the way, we have been conferred with
      ...
      <div className="infomid"></div>
      <div className="infomid">
        <h2 className="hed">INDIA’S LARGEST HEALTHCARE PLATFORM</h2>
        <div className="infomid-child">
          <div>
            <h2>260m+</h2>
            <p>Visitors</p>
          </div>
